...
export async function renderDashboard(view: DashboardView, searchParams: DashboardSearchParams) {
  ...
  return <Dashboard data={previewDashboard} deployment={deployment} onboarding={!root && params.preview !== "1"} rootQuery={root} nodeQuery={node} actionQuery={action} view={view} tour={tour} step={step} />;
}
