...
test('wallet handoff opens only the trusted URL in the normal browser and reports launch failure honestly',async()=>{
  const url='https://agent-capital-tree.vercel.app/setup?action=create-root&label=demo&budget=100000';
  ...
  assert.throws(()=>browserCommand('https://agent-capital-tree.vercel.app/other','win32',{}));
