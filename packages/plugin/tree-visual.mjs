...
export function treeAsSvg(tree, page = 0) {
  ...
  if (tree.mcp) {
    const m = tree.mcp;
    body += rect(32, 257, 976, 176, t.card, m.writeReady ? t.ring : t.border);
    ...
    body += text(52, 410, 'Chat-managed vaults · No autonomous worker process is running', {size:13,color:t.primary});
  }
  for (const { node, depth } of ordered) {
