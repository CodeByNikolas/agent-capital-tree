...
- Use pnpm for Node.js; keep Foundry versioned. Preserve existing HomeBox inference services. Jury workers use a dedicated native Codex login without CLIProxyAPI; the explicit proxy mode remains available for HomeBox. Leave hooks and automatic skill updates disabled.
