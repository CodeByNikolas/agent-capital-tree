...
<<<<<<< HEAD
Five header items separate Overview, Tree, Applications, Activity and Setup. Applications includes Uniswap and payment history. Fraunces and IBM Plex, explicit dark/light themes and the supplied logo follow [the corrected Kanoki design scope](KANOKI_DESIGN.md). USDC and DEMO-USD stay separate. Selecting a node opens its balance, capabilities and limits.
=======
