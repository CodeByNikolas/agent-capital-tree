...
- MultiBaas indexes capital and strategy activity for the dashboard and master agent. Indexed transactions are enriched through its receipt API and independently checked against Sepolia.
