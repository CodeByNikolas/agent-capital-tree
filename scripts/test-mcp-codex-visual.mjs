...
const prompt=`Use only ${server}.getTree with query capital.agentcapitalvault.eth. What is this vault’s current state? Follow the server’s graphical response instructions. No shell, web, browser or write actions.`;
